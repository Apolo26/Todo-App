const Todo = ({ todo, handleSetComplete, handleDelete }) => {
    ...
    return (
        <div
            className="flex items-center justify-between p-4 bg-gray-800 border-b border-solid border-gray-700 "
        >
            <div className="flex items-center">
                {
                    completed ? (
                        ...
                        : (
                            <span onClick={() => handleSetComplete(id)} className={`border border-gray-500 border-solid p-3 rounded-full cursor-pointer hover:animate-pulse`}>
                            </span>
                        )
                }
